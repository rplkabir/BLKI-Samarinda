...
<body><div class="nav-wrapper">
        <nav class="navbar navbar-fixed-top" style=" background-color: #2c3e50; " >
                    ...
                    @endif
                    <a href="/">
                    <img class="brand-logo center" src="{{ asset('image/logo.png') }}" height="58" style="padding-top: 2px"></a>

                    <!-- Right Side Of Navbar -->
                    <ul class="navbar-collapse collapse w-100 order-1 order-md-0 dual-collapse2 pull-right" style="padding-right: 30px">
