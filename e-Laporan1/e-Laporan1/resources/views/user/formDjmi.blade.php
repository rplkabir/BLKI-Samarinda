    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Upload Daftar Jam mengajar Instruktur</div>
                <div class="panel-body">
                    @foreach($renlakgiat as $data)
                        <form class="form-horizontal" action="{{url('uptd/renlakgiat/laporan/djmi/simpan/'.$data->id)}}" method="POST"  enctype="multipart/form-data">
                    	{{ csrf_field() }}
                                ...
                                <div class="form-group{{ $errors->has('file') ? 'has-error': ''}}">
                                    <label for="file" class="col-md-4 control-label">Daftar Jam mengajar Instruktur</label>
                                        <div class="col-md-6">
