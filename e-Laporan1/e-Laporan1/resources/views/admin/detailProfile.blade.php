    ...
    <div class="row">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">Dashboard Profil UPTD
                    ...
                    <img class="img materialboxed img-thumbnail" align="center" src="{{asset('upload/'.$data->foto_pimpinan)}}" width="180" height="180" style=" left:5%; top: 60%;  z-index: 0; position: absolute; float: left;">  
                    </div>
                    @endforeach
